...
substrate16 = {"directed": False, "multigraph": False,
               "graph": {
                   ...
                   "nodes": [  # در متن مقاله ذکر کرده است که 4 نود core و 12 نود edge داریم
                       {"type": 0, "cpu": 300, "id": 0},
                       {"type": 1, "cpu": 100, "id": 1},
                       {"type": 1, "cpu": 100, "id": 2},
                       {"type": 0, "cpu": 300, "id": 3},
...
abilene = {'directed': False, 'multigraph': False,
           'graph': {
               ...
               'Version': '1.0', 'Type': 'REN', 'DateType': 'Historic', 'Backbone': 1, 'Commercial': 0, 'label':
                   'Abilene', 'ToolsetVersion': '0.3.34dev-20120328', 'Customer': 0, 'IX': 0,
               'SourceGitVersion': 'e278b1b',
               'DateModifier': '=', 'DateMonth': '02', 'LastAccess': '3/02/11', 'Layer': 'IP',
               'Creator': 'Topology Zoo Toolset',
               'Developed': 0, 'Transit': 0, 'NetworkDate': '2005_02', 'DateYear': '2005',
               ...
               'nodes': [
                   {"type": 1, "cpu": 100, 'Country': 'United States', 'Longitude': -74.00597, 'Internal': 1,
                    'Latitude': 40.71427, 'id': 'New York'},
                   {"type": 0, "cpu": 300, 'Country': 'United States', 'Longitude': -87.65005, 'Internal': 1,
                    'Latitude': 41.85003, 'id': 'Chicago'},
                   {"type": 1, "cpu": 100, 'Country': 'United States', 'Longitude': -77.03637, 'Internal': 1,
                    'Latitude': 38.89511, 'id': 'Washington DC'},
                   {"type": 1, "cpu": 100, 'Country': 'United States', 'Longitude': -122.33207, 'Internal': 1,
                    'Latitude': 47.60621, 'id': 'Seattle'},
                   {"type": 1, "cpu": 100, 'Country': 'United States', 'Longitude': -122.03635, 'Internal': 1,
                    'Latitude': 37.36883, 'id': 'Sunnyvale'},
                   {"type": 0, "cpu": 300, 'Country': 'United States', 'Longitude': -118.24368, 'Internal': 1,
                    'Latitude': 34.05223, 'id': 'Los Angeles'},
                   {"type": 1, "cpu": 100, 'Country': 'United States', 'Longitude': -104.9847, 'Internal': 1,
                    'Latitude': 39.73915, 'id': 'Denver'},
                   {"type": 1, "cpu": 100, 'Country': 'United States', 'Longitude': -94.62746, 'Internal': 1,
                    'Latitude': 39.11417, 'id': 'Kansas City'},
                   {"type": 0, "cpu": 300, 'Country': 'United States', 'Longitude': -95.36327, 'Internal': 1,
                    'Latitude': 29.76328, 'id': 'Houston'},
                   {"type": 1, "cpu": 100, 'Country': 'United States', 'Longitude': -84.38798, 'Internal': 1,
                    'Latitude': 33.749, 'id': 'Atlanta'},
                   {"type": 1, "cpu": 100, 'Country': 'United States', 'Longitude': -86.15804, 'Internal': 1,
                    'Latitude': 39.76838, 'id': 'Indianapolis'}
               ],
               'links': [
                   {"bw": 50, 'LinkType': 'OC-192', 'LinkLabel': 'OC-192c', 'LinkNote': 'c', 'source': 'New York',
                    'target': 'Chicago'},
                   {"bw": 50, 'LinkType': 'OC-192', 'LinkLabel': 'OC-192c', 'LinkNote': 'c', 'source': 'New York',
                    'target': 'Washington DC'},
                   {"bw": 50, 'LinkType': 'OC-192', 'LinkLabel': 'OC-192c', 'LinkNote': 'c', 'source': 'Chicago',
                    'target': 'Indianapolis'},
                   {"bw": 50, 'LinkType': 'OC-192', 'LinkLabel': 'OC-192c', 'LinkNote': 'c', 'source': 'Washington DC',
                    'target': 'Atlanta'},
                   {"bw": 50, 'LinkType': 'OC-192', 'LinkLabel': 'OC-192c', 'LinkNote': 'c', 'source': 'Seattle',
                    'target': 'Sunnyvale'},
                   {"bw": 50, 'LinkType': 'OC-192', 'LinkLabel': 'OC-192c', 'LinkNote': 'c', 'source': 'Seattle',
                    'target': 'Denver'},
                   {"bw": 50, 'LinkType': 'OC-192', 'LinkLabel': 'OC-192c', 'LinkNote': 'c', 'source': 'Sunnyvale',
                    'target': 'Los Angeles'},
                   {"bw": 50, 'LinkType': 'OC-192', 'LinkLabel': 'OC-192c', 'LinkNote': 'c', 'source': 'Sunnyvale',
                    'target': 'Denver'},
                   {"bw": 50, 'LinkType': 'OC-192', 'LinkLabel': 'OC-192c', 'LinkNote': 'c', 'source': 'Los Angeles',
                    'target': 'Houston'},
                   {"bw": 50, 'LinkType': 'OC-192', 'LinkLabel': 'OC-192c', 'LinkNote': 'c', 'source': 'Denver',
                    'target': 'Kansas City'},
                   {"bw": 50, 'LinkType': 'OC-192', 'LinkLabel': 'OC-192c', 'LinkNote': 'c', 'source': 'Kansas City',
                    'target': 'Houston'},
                   {"bw": 50, 'LinkType': 'OC-192', 'LinkLabel': 'OC-192c', 'LinkNote': 'c', 'source': 'Kansas City',
                    'target': 'Indianapolis'},
                   {"bw": 50, 'LinkType': 'OC-192', 'LinkLabel': 'OC-192c', 'LinkNote': 'c', 'source': 'Houston',
                    'target': 'Atlanta'},
                   {"bw": 50, 'LinkType': 'OC-192', 'LinkLabel': 'OC-192c', 'LinkNote': 'c', 'source': 'Atlanta',
                    'target': 'Indianapolis'}
               ]}
           }
