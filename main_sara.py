...
def update_resources(substrate,nslr,kill):
    ...
    for vnf in nslr.nsl_graph_reduced["vnodes"]:#se recorre los nodos del grafo reducido del nslr aceptado    =the nodes of the reduced graph of the accepted nslr are used
        if "mapped_to" in vnf:
